...
struct DriverHelper abstract final {
	...
	static HANDLE OpenHandle(void* pObject, ACCESS_MASK = GENERIC_READ);
	static HANDLE DupHandle(HANDLE hObject, ULONG pid, ACCESS_MASK acess = GENERIC_READ, DWORD flags = DUPLICATE_SAME_ACCESS);
...
private:
	...
	inline static HANDLE s_hDevice;
};
