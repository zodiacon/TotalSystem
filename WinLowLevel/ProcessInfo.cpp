...
const std::wstring& WinLL::ProcessInfo::GetImageName() const {
	return m_ProcessName;
}

const std::wstring& WinLL::ProcessInfo::GetPackageFullName() const {
	return m_PackageFullName;
}

const std::wstring& WinLL::ProcessInfo::GetNativeImagePath() const {
