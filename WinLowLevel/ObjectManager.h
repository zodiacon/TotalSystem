...
namespace WinLLX {
	...
	public:
		...
		static std::wstring GetObjectName(HANDLE hObject, ULONG pid, USHORT type);
		static std::wstring GetObjectName(HANDLE hDup, USHORT type);
	...
	private:
		static wil::unique_virtualalloc_ptr<SYSTEM_HANDLE_INFORMATION_EX> EnumHandlesBuffer();
